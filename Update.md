...
* Removed all timetable, homework and profile uploads from the licence API and added a migration that permanently drops `public.license\_assignments`.
